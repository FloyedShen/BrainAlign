...
class AlignmentMetrics:
    ...
    def cycle_knn(feats_A, feats_B, topk):
        # feats_A, feats_B = align_features_pca(feats_A, feats_B)
    ...
    @staticmethod
    def cka(feats_A, feats_B, kernel_metric='ip', rbf_sigma=1e3, unbiased=False):
        # print(rbf_sigma, unbiased)
        # print(kernel_metric)
...
def align_features_pca(feats_A, feats_B):
