...
if __name__ == '__main__':
    ...
    ckpt_dict = {
        ...
        'mixnet_s': '20250317-143211-mixnet_s-224',
        'mixnet_m': '20250317-220537-mixnet_m-224',
        'mixnet_l': '20250317-143505-mixnet_l-224',
    }

    results = []
    for use_ema in [False, True]:
        args.use_ema = use_ema
        for model, ckpt in ckpt_dict.items():
            for epoch in tqdm([0, 1, 2, 4, 8, 32, 64, 128, 256, 384, 450], desc=f"{model}-{use_ema}"):
                checkpoint = f'./output/train/{ckpt}/checkpoint-{epoch}.pth.tar'
    ...
    df.to_csv('../../../../data/intermediate_results/results.csv', index=False)